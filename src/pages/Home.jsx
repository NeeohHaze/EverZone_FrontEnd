...
function Home() {
  ...
  return (
    <div className="relative flex flex-col items-center pt-6 pb-24 px-6 lg:px-16 w-full bg-white min-h-[calc(100vh-80px)]">
      ...
      {/* Center: Text Content */}
      <div className="flex flex-col items-center text-center max-w-4xl z-10 mb-12">
        {/* Replaced hardcoded title with t("home.title") */}
        <h1 className="text-4xl md:text-5xl lg:text-[3.5rem] font-medium text-slate-700 leading-tight mb-6">
          {t("home.title")}
        </h1>

        {/* Replaced hardcoded subtitle with t("home.subtitle") */}
        <p className="text-lg text-slate-500 mb-10 max-w-2xl font-serif">
          {t("home.subtitle")}
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-5">
          <a
            href="#projects"
            className="group flex items-center justify-center gap-3 rounded-full bg-[#113243] px-8 py-3.5 text-white transition-all shadow-md hover:bg-[#18445a]"
          >
            {/* Replaced hardcoded button text */}
      ...
      {/* Bottom Left: Social Icons & Copyright */}
