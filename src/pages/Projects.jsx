  ...
  return (
    <div className="min-h-screen bg-white pt-16 pb-24">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        {/* 1. The Blue Box (Only the top padding is visible now!) */}
        <div className="bg-[#113243] rounded-[3rem] pt-6 md:pt-8 w-full shadow-[0_10px_40px_-15px_rgba(17,50,67,0.2)]">
          {filteredProjects.length === 0 ? (
            /* Empty State White Card */
            <div className="text-center text-slate-500 py-20 bg-white rounded-t-[2.5rem] md:rounded-t-[3rem] rounded-b-[3rem] w-full h-full shadow-sm">
            ...
            /* 2. Main Project Display White Card (Covers the left, right, and bottom of the blue box) */
            <div className="bg-white rounded-t-[2.5rem] md:rounded-t-[3rem] rounded-b-[3rem] w-full h-full px-6 md:px-16 py-10 md:py-12 flex flex-col relative shadow-sm">
              {/* Floating Left & Right Navigation Arrows */}
              <button
                onClick={prevProject}
                className="absolute left-2 md:left-5 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 bg-white border border-slate-200 rounded-full shadow-md flex items-center justify-center text-slate-400 hover:text-[#7fc41b] hover:border-[#7fc41b] transition-all z-20"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
              ...
              <button
                onClick={nextProject}
                className="absolute right-2 md:right-5 top-1/2 -translate-y-1/2 w-10 h-10 md:w-12 md:h-12 bg-white border border-slate-200 rounded-full shadow-md flex items-center justify-center text-slate-400 hover:text-[#7fc41b] hover:border-[#7fc41b] transition-all z-20"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
              ...
              <div className="flex flex-col lg:flex-row gap-12 w-full">
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center">
                  ...
                  {/* Title & Description */}
                  <h2 className="text-3xl md:text-4xl font-medium text-slate-700 mb-6 leading-tight">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {/* Area */}
                    <div className="flex flex-col items-center justify-center text-center p-5 border border-slate-100 rounded-[1.5rem] bg-white shadow-sm transition-shadow hover:shadow-md">
                      <svg
                ...
                <div className="w-full lg:w-1/2 flex items-center justify-center">
                  <div className="relative w-full h-[350px] md:h-[450px] lg:h-full min-h-[400px]">
